                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ingredient" value="<?php echo $row['ingredient'] ?>" placeholder="ส่วนประกอบ">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group text-right" style="margin-top: 20px;">
                                        ...
                                        <a href="productUser.php" class="btn btn-danger">ยกเลิก</a>
                                    </div>
                                </form>
                            </div>
                        </div>
