    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <div class="input-group">
                <input name="search" value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>" class="form-control" type="text" placeholder="Search for..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        if ($result->num_rows === 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) { ?>
                                                                                            <tr >
                                                <td onclick="location.href='showProduct.php?product_id=<?php echo htmlspecialchars($row['product_id']) ?>'"><?php echo $row['barcode_id'] ?></td>
                                                <td onclick="location.href='showProduct.php?product_id=<?php echo htmlspecialchars($row['product_id']) ?>'"><?php echo $row['product_name'] ?></td>
                                                <td onclick="location.href='showProduct.php?product_id=<?php echo htmlspecialchars($row['product_id']) ?>'">
                                                <?php
                                                ...
                                                <td onclick="location.href='showProduct.php?product_id=<?php echo htmlspecialchars($row['product_id']) ?>'"><?php echo $row['type'] ?></td>
                                                <td>
                                                    <a href="editproduct.php?product_id=<?php echo htmlspecialchars($row['product_id']) ?>" class="btn btn-warning btn-sm">
